...
\begin{enumerate}
  ...
  \item To enable administrators to upload student academic data in bulk via CSV/Excel formats.
...
\begin{longtable}{|p{1.2cm}|p{4.5cm}|p{4.0cm}|p{2.5cm}|p{1.5cm}|}
\hline
...
\end{axis}
\end{tikzpicture}
\caption{Module-wise Development Progress}
\end{figure}
