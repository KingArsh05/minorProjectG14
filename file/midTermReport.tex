...
\begin{tikzpicture}[
  ...
  \draw[arrow] (ui.15) -- node[above, font=\tiny] {1.2 Send CSV} (backend.165);
  \draw[arrow] (backend.270) -- node[right, font=\tiny] {1.3 Insert Records} (db.90);
  \draw[arrow] (db.105) -| node[above left, font=\tiny] {1.4 Acknowledge} (backend.215);
  \draw[arrow] (backend.195) -- node[below, font=\tiny] {1.5 Success Res} (ui.345);
